...
ECHO_CMD = echo
CC = cc
LDFLAGS +=  -L/usr/local/lib/ -L/usr/local/lib/ -lrt -lnsl -lresolv -pthread -lcrypto -lssl -levent_core -levent_extra -levent_openssl -levent_pthreads -lsqlite3  -Wl,-rpath,/usr/local/lib/ -Wl,-rpath,/usr/local/lib/ -Wl,-rpath,/usr/local/mysql/lib -Wl,-rpath,/usr/local/mysql/lib -Wl,-rpath,/usr/lib/mysql -Wl,-rpath,/usr/local/lib
DBLIBS +=  -lsqlite3  -L/usr/local/lib/ -L/usr/local/lib/ -lrt -lnsl -lresolv -pthread -lcrypto -lssl -levent_core -levent_extra -levent_openssl -levent_pthreads -lsqlite3  -L/usr/local/mysql/lib -L/usr/local/mysql/lib -L/usr/lib/mysql -lmysqlclient
...
CPPFLAGS = 
DBCFLAGS +=  -I/usr/local/mysql/include -I/usr/local/include/mysql/ -I/usr/local/mysql/include -I/usr/local/include/mysql/ -I/usr/mysql/include -I/usr/include/mysql/ -DTURN_NO_PQ   -DTURN_NO_MONGO -DTURN_NO_HIREDIS
#
PORTNAME = turnserver
PREFIX = /usr/local
prefix = /usr/local
